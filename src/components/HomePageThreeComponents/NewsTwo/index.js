...
export default function NewsTwo() {
  return (
    <section className="news-section home-3">
                        ...
                        <div className="inner-box">
                            ...
                            <div className="lower-content">
                                <ul className="post-info">
                                    <li><span>by</span>&nbsp;<a href="index-3.html">Nicolas</a></li>
                                    <li><a href="index-3.html">3 Comments</a></li>
                                </ul>
                ...
                <div className="col-lg-4 col-md-6 col-sm-12 news-block">
                    <div className="news-block-one wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div className="inner-box">
                            ...
                            <div className="lower-content">
                                <ul className="post-info">
                                    <li><span>by</span>&nbsp;<a href="index-3.html">Hinter</a></li>
                                    <li><a href="index-3.html">5 Comments</a></li>
                                </ul>
                ...
                <div className="col-lg-4 col-md-6 col-sm-12 news-block">
                    <div className="news-block-one wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div className="inner-box">
                            ...
                            <div className="lower-content">
                                <ul className="post-info">
                                    <li><span>by</span>&nbsp;<a href="index-3.html">Tailor</a></li>
                                    <li><a href="index-3.html">4 Comments</a></li>
                                </ul>
