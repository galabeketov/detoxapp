        ...
        <div className="auto-container">
            <div className="row">
                <div className="col-lg-4 col-md-6 col-sm-12 feature-block">
                    <div className="feature-block-one wow flipInY" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div className="inner-box js-tilt">
                            ...
                            <div className="btn-box"><a href="index.html" className="theme-btn style-two">Learn More</a></div>
                        </div>
                    </div>
                </div>
                <div className="col-lg-4 col-md-6 col-sm-12 feature-block">
                    <div className="feature-block-one wow flipInY" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div className="inner-box js-tilt">
                            <div className="icon-box">
                                <div className="anim-icon">
                                    <span className="icon icon-1"></span>
                ...
                <div className="col-lg-4 col-md-6 col-sm-12 feature-block">
                    <div className="feature-block-one wow flipInY" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div className="inner-box js-tilt">
                            <div className="icon-box">
                                <div className="anim-icon">
                                    <span className="icon icon-1"></span>
