...
export default function TeamSection() {
  return (
    <section className="team-section text-center sec-pad">
      <div className="auto-container">
        <div className="inner-content">
          <div className="row clearfix">
            <div className="col-lg-4 col-md-6 col-sm-12 team-block">
              <div
                className="team-block-one mb-100 wow fadeInUp"
                data-wow-delay="00ms"
                ...
                <div className="inner-box">
                  ...
                  <div className="lower-content">
                    <h3>
                      <a href="team.html">Nicolas Lawson</a>
                    </h3>
            ...
            <div className="col-lg-4 col-md-6 col-sm-12 team-block">
              <div
                ...
                <div className="inner-box">
                  ...
                  <div className="lower-content">
                    <h3>
                      <a href="team.html">Gwen Johnson</a>
                    </h3>
            ...
            <div className="col-lg-4 col-md-6 col-sm-12 team-block">
              <div
                ...
                <div className="inner-box">
                  ...
                  <div className="lower-content">
                    <h3>
                      <a href="team.html">Thomas Olsen</a>
                    </h3>
                    <span className="designation">Regional Leader</span>
                  </div>
                </div>
              </div>
            </div>
