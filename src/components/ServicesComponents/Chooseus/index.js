                    ...
                    <div id="content_block_08">
                        <div className="content-box">
                            <div className="top-box">
                                ...
                                <div className="text wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                            ...
                            <div className="inner-box clearfix wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                ...
                <div className="col-lg-6 col-md-12 col-sm-12">
                    <div id="image_block_07">
                        <div className="image-box wow slideInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <figure className="image js-tilt"><img src="images/service/service-1.png" alt=""/></figure>
                        </div>
                    </div>
                </div>
            </div>
